    ...
    success:function(monObjet) {
     ...
     var element = document.getElementById("auj");
         ...
         monObjet.current_condition.condition_key=="faibles-passages-nuageux") {
             ...
             $('#icon1').attr("src","img/nuageux.png");
         }
...
//                      jour2
         ...
         monObjet.fcst_day_1.condition_key=="faibles-passages-nuageux") {
             ...
             $('#icon2').attr("src","img/nuageux.png");
         }
...
//                      jour3
         ...
         monObjet.fcst_day_2.condition_key=="faibles-passages-nuageux") {
             ...
             $('#icon3').attr("src","img/nuageux.png");
         }
...
//                      jour5
        ...
        if (monObjet.fcst_day_4.fcst_day_4=="ensoleille"|| monObjet.fcst_day_4.condition_key=="eclaircies"||monObjet.fcst_day_4.condition_key=="averses-de-pluie-faible"||
